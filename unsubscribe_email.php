<?php
   ...
   require('functions.inc.php');
    ...
    if(isset($_GET['email']))
    {
        ...
        mysqli_query($con,"update `email_subscribe` set `status`='0' where `email`='$email'");
    }
    }
    if(isset($_GET['email']))
    {
...
<html lang="en-US">
   <head>
      <meta charset="UTF-8">
      <title><?php if(!isset($_GET['email'])){ ?>Unsubscribe Your Email<?php }else { echo $email;?> has been unsubscribed <?php }?> | <?php $row['meta_title'];?></title>
      <meta name="description" content="<?php $row['meta_desc'];?>">
        <meta name="keywords" content="<?php $row['meta_keywords'];?>">
                           ...
                           <div class="ekit-wid-con">
                              <div class="ekit-heading elementskit-section-title-wraper center   ekit_heading_tablet-   ekit_heading_mobile-">
                                 <h2 class="ekit-heading--title elementskit-section-title ">
                                    Unsubscribe Your <span>Email</span>
                                 </h2>
                  ...
                  <div class="elementor-widget-wrap elementor-element-populated">
                     <div class="elementor-element elementor-element-a4dae4e elementor-widget elementor-widget-text-editor" data-id="a4dae4e" data-element_type="widget" data-widget_type="text-editor.default">
                        <div class="elementor-widget-container">
                           ...
                           if(!isset($_GET['email'])){ ?>
                           <form method="get">
                           <input style="width: 50%;margin-left: 287px;border-radius: 20px;border-color:#2ae9cd;" type="email" name="email" placeholder="Enter your email" required>
                           <input style="margin: 8px;margin-left: 500px;border: solid;border-radius: 18px;background-color:#2ae9cd;border-color:#2ae9cd;color:#fff;" type="submit" name="submit" value="Unsubscribe">
                           </form>
                           <?php }
                           ?>
                           <?php 
                           if(isset($_GET['email'])){ ?>
                           <p style="text-align:center;margin:10px;">Your email <b><?php echo $email;?></b> has been unsubscribed successfully.</p>
                           <?php } ?>
                        </div>
                     </div>
                  </div>
