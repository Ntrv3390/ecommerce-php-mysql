<?php
   ...
   require('functions.inc.php');
    ...
    $sql_blog="select blog.*,categories from blog, blog_categories where blog.blog_category=blog_categories.id order by blog.id desc";
...
<html lang="en-US">
   <head>
      <meta charset="UTF-8">
      <title>Read Our Blogs | Swipe Right</title>
                                       ...
                                       <div class="ekit-wid-con">
                                          <div id="post-items--3967e213" class="row post-items">
                                            ...
                                            <div class="col-lg-4 col-md-6" >
                                                <div style="border:0px solid;border-radius:25px;"class="elementskit-post-image-card">
                                                   <div style="background-color:#fff;"class="elementskit-entry-header">
                                                      <a href="blog_post/<?php echo $row_blog['alias']; ?>" style="background-color:#fff;"class="elementskit-entry-thumb">
                                                      <img src="/wp-content/uploads/2022/08/<?php echo PRODUCT_IMAGE_SITE_PATH.$row_blog['blog_image']?>" alt="<?php echo $row_blog['categories'] ?>"></a>
                                                   </div>
                                                   <!-- .elementskit-entry-header END -->
                                                   <div class="elementskit-post-body " style="padding-bottom:10px;background-color:#fff;">
                                                      <div class="post-meta-list">
                                                         <span class="meta-author">
                                                         <i aria-hidden="true" style="color:blue;" class="icon icon-user"></i>
                                                         <a style="color:blue;" href="blog_post/<?php echo $row_blog['alias']; ?>" class="author-name"><?php echo $row_blog['author'];?></a>
                                                         </span>
                                                         <span class="post-cat">
                                                         <i style="color:blue;" aria-hidden="true" class="icon icon-folder"></i>
                                                         <a style="color:blue;" href="blog_post/<?php echo $row_blog['alias']; ?>" rel="category tag"><?php echo $row_blog['categories'];?></a>									</span>
                                                      </div>
                                                      <h2 class="entry-title">
                                                         <a style="color:#000;" href="blog_post/<?php echo $row_blog['alias']; ?>">
