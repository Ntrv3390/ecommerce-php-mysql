...
if(isset($_POST['submit'])){
	...
	mysqli_query($con,"update cta set cta_img='$image' ");
	?>
<script>window.location.href="cta"</script>
	<?php
	die();
	}
?>
<div class="content pb-0">
            <div class="animated fadeIn">
               <div class="row">
                  <div class="col-lg-12">
                     <div class="card">
                        <div class="card-header"><strong>Update CTA Image</strong></div>
                        <form method="post" enctype="multipart/form-data">
							<div class="card-body card-block">
                            <div class="form-group">
									<label for="categories" class=" form-control-label">Old CTA Image</label></br>
                                ...
                                <div class="form-group">
									<label for="image" class=" form-control-label">Upload New CTA Image</label>
									<input type="file" required name="image" class="form-control">
								</div>
							   <button id="payment-button" name="submit" type="submit" class="btn btn-lg btn-info btn-block">
							   <span id="payment-button-amount">Upload New CTA Image</span>
							   </button>
							</div>
						</form>
                     </div>
