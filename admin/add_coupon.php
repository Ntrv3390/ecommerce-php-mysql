...
if(isset($_POST['submit'])){
	...
	if($msg==''){
		...
		?>
		<script>
			window.location.href="<?php echo SITE_PATH ?>/admin/coupon_manage";
		</script>
...
<div class="content pb-0">
            <div class="animated fadeIn">
               <div class="row">
                  <div class="col-lg-12">
                     <div class="card">
                        <div class="card-header"><strong>Add/Update Coupon</strong></div>
