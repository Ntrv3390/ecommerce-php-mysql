...
if (isset($_POST["submit"])) {
    $sender_name=get_safe_value($con,$_POST['sender_name']);
    $sender_email=get_safe_value($con,$_POST['sender_email']);
    $subject=get_safe_value($con,$_POST['subject']);
    $body=get_safe_value($con,$_POST['body']);
    $sql_news = "select * from email_subscribe where status=1";
                              ...
                              <tr>
                                <td class="content-cell" align="center">
                                  ...
                                  <p class="f-fallback sub align-center">
                                    ...
                                    <br>1234 Street Rd.
                                    <br>Suite 1234
                                  </p><p>Dont want to receive updates? <a href="https://swiperight.in/unsubscribe_email">Unsubscribe here</a>.</p>
                                </td>
                              </tr>
                            </table>
                          </td>
    ...
    while($row_news=mysqli_fetch_assoc($res_news)) {
        $mail->addAddress($row_news['email']);
        $mail->IsHTML(true);
