...
function user_register(){
	...
	if(name==""){
		...
		jQuery('#number_error').html('Please enter mobile no');
		is_error='yes';
	}if(password==""){
	...
	if(is_error==''){
		jQuery.ajax({
			...
			type:'post',
			data:'name='+name+'&email='+email+'&number='+number+'&password='+password,
			success:function(result){
...
function email_register_footer(){
	jQuery('.field-error').html('');
	var email=jQuery("#email_footer").val();
	var is_error='';
if(email==""){
		jQuery('#email_error_footer').html('Please enter your email');
		is_error='yes';
        }
        if(is_error==''){
		jQuery.ajax({
			url:'email_newsletter_success',
			type:'post',
			data:'email='+email,
			success:function(result){
				if(result=='email_present'){
					jQuery('#email_error_footer').html('Email id already present');
                    jQuery('.register_email_msg p').html('');
				}
				if(result=='insert'){
                    jQuery('#email_error_footer').html('Great! Your email is registerd successfully');
				}
			}	
		});
	}
...
if(email==""){
		...
		jQuery.ajax({
			...
			success:function(result){
				...
				if(result=='insert'){
                    jQuery('#email_error').html('Great! Your email is registerd successfully');
				}
			}	
		});
	}
