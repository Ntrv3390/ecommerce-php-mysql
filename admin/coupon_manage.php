...
$sql1="select * from coupon_master";
if(isset($_GET['search_submit']))
{
    $search = get_safe_value($con,$_GET['search']);
    if($search!=''){
        $sql1.=" where coupon_master.id like '%$search%' or coupon_master.coupon_code like '%$search%' order by id desc";
    }
}else{
	...
	<div class="orders">
	   <div class="row">
		  <div class="col-xl-12">
			 <div class="card">
				<div class="card-body">
				   <h4 class="box-title">Coupon Management</h4>
                   <h4 class="box-link"><a href="add_coupon">Add new coupon</a> </h4>
                   <form method="get">
							<div class="card-body card-block">
                                <div class="form-group" style="margin-top: -70px; margin-left:400px;">
									<input  type="text" style="width:70%;margin-bottom:-5px;height:45px;margin-left:58px;" name="search" placeholder="Search in coupon-code - coupon value or id..." class="form-control">
					  ...
					  <table class="table ">
						 ...
						 <tbody>
							...
							<tr>
							   ...
							   <td><?php echo $row1['coupon_value']?></td>
							   <td><?php echo $row1['coupon_type']?></td>
							   <td><?php echo $row1['cart_min_value']?></td>
							   <td>
                               <?php
								if($row1['status']==1){
                                ...
                                echo "<span class='badge badge-edit'><a href='add_coupon/".$row1['id']."'>Edit</a></span>&nbsp;";
