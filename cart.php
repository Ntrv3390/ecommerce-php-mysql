                                ...
                                <table>
                                    ...
                                    <tbody>
										...
										if(isset($_SESSION['cart'])){
											...
											$pname=$productArr[0]['product_title_black'];
											$mrp=$productArr[0]['cancel_price'];
											$price=$productArr[0]['actual_price'];
											$image=$productArr[0]['image'];
											$qty=$val['qty'];
											?>
											<tr>
												<td class="product-thumbnail"><a href="#"><img src="wp-content/uploads/2022/08/<?php echo PRODUCT_IMAGE_SITE_PATH.$image?>"  /></a></td>
												...
												<td class="product-remove"><a href="javascript:void(0)" onclick="manage_cart('<?php echo $key?>','remove')"><i class="icon-trash icons"></i>Remove</a></td>
											</tr>
											<?php } } ?>
                                    </tbody>
                                </table>
