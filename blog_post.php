<?php
   ...
   require('functions.inc.php');
    ...
    $sqls="select * from blog where alias='$alias'";
...
<html lang="en-US">
   <head>
      <meta charset="UTF-8">
      <title><?php echo $rowss['blog_title'];?></title>
      <meta name="description" content="<?php echo $rowss['meta_description'];?>">
        <meta name="keywords" content="<?php echo $rowss['meta_keyword'];?>">
      ...
      <link rel="stylesheet" id="wp-block-library-css" href="<?php echo SITE_PATH?>/wp-includes/css/dist/block-library/style.min.css?ver=5.5.9" media="all">
      <link rel="stylesheet" id="hello-elementor-css" href="<?php echo SITE_PATH?>/wp-content/themes/hello-elementor/style.min.css?ver=2.6.1" media="all">
      <link rel="stylesheet" id="hello-elementor-theme-style-css" href="<?php echo SITE_PATH?>/wp-content/themes/hello-elementor/theme.min.css?ver=2.6.1" media="all">
      <link rel="stylesheet" id="elementor-frontend-css" href="<?php echo SITE_PATH?>/wp-content/plugins/elementor/assets/css/frontend-lite.min.css?ver=3.7.0" media="all">
      <link rel="stylesheet" id="elementor-post-5-css" href="<?php echo SITE_PATH?>/wp-content/uploads/elementor/css/post-5.css?ver=1660386820" media="all">
      <link rel="stylesheet" id="elementor-icons-ekiticons-css" href="<?php echo SITE_PATH?>/wp-content/plugins/elementskit-lite/modules/elementskit-icon-pack/assets/css/ekiticons.css?ver=2.6.3" media="all">
      <link rel="stylesheet" id="elementor-icons-css" href="<?php echo SITE_PATH?>/wp-content/plugins/elementor/assets/lib/eicons/css/elementor-icons.min.css?ver=5.16.0" media="all">
      <link rel="stylesheet" id="elementor-global-css" href="<?php echo SITE_PATH?>/wp-content/uploads/elementor/css/global.css?ver=1660388423" media="all">
      <link rel="stylesheet" id="elementor-post-740-css" href="<?php echo SITE_PATH?>/wp-content/uploads/elementor/css/post-740.css?ver=1661406500" media="all">
      <link rel="stylesheet" id="ekit-widget-styles-css" href="<?php echo SITE_PATH?>/wp-content/plugins/elementskit-lite/widgets/init/assets/css/widget-styles.css?ver=2.6.3" media="all">
      <link rel="stylesheet" id="ekit-responsive-css" href="<?php echo SITE_PATH?>/wp-content/plugins/elementskit-lite/widgets/init/assets/css/responsive.css?ver=2.6.3" media="all">
      ...
      <link rel="stylesheet" id="elementor-icons-shared-0-css" href="<?php echo SITE_PATH?>/wp-content/plugins/elementor/assets/lib/font-awesome/css/fontawesome.min.css?ver=5.15.3" media="all">
      <link rel="stylesheet" id="elementor-icons-fa-solid-css" href="<?php echo SITE_PATH?>/wp-content/plugins/elementor/assets/lib/font-awesome/css/solid.min.css?ver=5.15.3" media="all">
      <link rel="stylesheet" id="elementor-icons-fa-brands-css" href="<?php echo SITE_PATH?>/wp-content/plugins/elementor/assets/lib/font-awesome/css/brands.min.css?ver=5.15.3" media="all">
      ...
      <link rel="icon" href="<?php echo SITE_PATH?>/wp-content/uploads/2022/08/cropped-photo1660568483-removebg-preview-32x32.png" sizes="32x32">
      <link rel="icon" href="<?php echo SITE_PATH?>/wp-content/uploads/2022/08/cropped-photo1660568483-removebg-preview-192x192.png" sizes="192x192">
      <link rel="apple-touch-icon" href="<?php echo SITE_PATH?>/wp-content/uploads/2022/08/cropped-photo1660568483-removebg-preview-180x180.png">
                           ...
                           <div class="ekit-wid-con">
                              <div class="ekit-heading elementskit-section-title-wraper center   ekit_heading_tablet-   ekit_heading_mobile-">
                                 <h2 class="ekit-heading--title elementskit-section-title ">
                                    Blog ><span><span><?php echo $rowss['blog_title']; ?></span></span>
                                 </h2>
                  ...
                  <div class="elementor-widget-wrap elementor-element-populated">
                     <div class="elementor-element elementor-element-a4dae4e elementor-widget elementor-widget-text-editor" data-id="a4dae4e" data-element_type="widget" data-widget_type="text-editor.default">
                        <div class="elementor-widget-container">
                           ...
                           <p><?php echo $rowss['blog_description'];?></p>
                        </div>
                     </div>
                  </div>
               </div>
