...
$order_id=$_GET['id'];
$res=mysqli_query($con,"select distinct(order_detail.id) ,order_detail.*,product.product_title_black,product.product_title_blue,product.image from order_detail,product ,`order` where order_detail.order_id='$order_id' and order_detail.product_id=product.id");
$row1=mysqli_fetch_array($con,$res);
          ...
          <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
            <tr>
              <td class="email-masthead">
                ...
                '.$row1['product_title_black'].' '.$row1['product_title_blue'].'
              </a>
              </td>
            </tr>
            <!-- Email Body -->
                            ...
                            <td colspan="2">
                              <table class="purchase_content" width="100%" cellpadding="0" cellspacing="0">
                                ...
                                while($row=mysqli_fetch_assoc($res)){
									...
									$html.='<tr>
									  <td width="80%" class="purchase_item"><span class="f-fallback">'.$row['first_name'].' '.$row['last_name'].'</span></td>
