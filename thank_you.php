...
<html lang="en-US">
   <head>
      <meta charset="UTF-8">
      <title>Thank You For Purchasing | Sneaker Wipes - Swipe Right</title>
      <meta name="description" content="Thank You For Purchasing | Sneaker Wipes - Swipe Right">
        <meta name="keywords" content="sneaker wipes, shoe cleaning wipes, sneaker cleaning wipes, swipe right">
                           ...
                           <div class="ekit-wid-con">
                              <div class="ekit-heading elementskit-section-title-wraper center   ekit_heading_tablet-   ekit_heading_mobile-">
                                 <h2 class="ekit-heading--title elementskit-section-title ">
                                   Your order has been placed successfully!</span></span>
                                 </h2>
                  ...
                  <div class="elementor-widget-wrap elementor-element-populated">
                     <div class="elementor-element elementor-element-a4dae4e elementor-widget elementor-widget-text-editor" data-id="a4dae4e" data-element_type="widget" data-widget_type="text-editor.default">
                        <div class="elementor-widget-container">
                           ...
                           <p style="text-align:center;">We have received your order. We have sent you an invoice of the purchase on your email. Keep checking your email for the status of your package. Have a great day!</p>
                        </div>
                     </div>
                  </div>
               </div>
